...
const ru = {
  ...
  // Две карточки режимов на главном экране.
  'menu.mode.platformer.name': 'Марио-режим',
  'menu.mode.platformer.desc': 'Беги и прыгай по уровням, решай задачи и открывай двери.',
  'menu.mode.dungeon.name': 'Данж',
  'menu.mode.dungeon.desc': 'Рогалик: зачищай комнаты, добывай знания, спускайся глубже.',

  // --- Туториал ---
  'howto.title': 'Как играть',
  'howto.goal': 'Цель',
  'howto.controls': 'Управление',
  'howto.tips': 'Полезно знать',
  'howto.touch': 'На телефоне то же самое — кнопки и джойстики прямо на экране.',
  'howto.start': 'Начать!',
  'howto.platformer.name': 'Марио-режим',
  'howto.platformer.goal': 'Добеги до двери или флага. У сундука реши задачу — получишь ключ. Не падай в ямы и на шипы.',
  'howto.dungeon.name': 'Данж',
  'howto.dungeon.goal': 'Зачисти комнату от врагов — тогда откроются двери. Спускайся всё ниже и не дай знаниям (HP) кончиться.',
  'howto.p.move': 'бежать',
  'howto.p.jump': 'прыгать',
  'howto.p.interact': 'открыть сундук или дверь',
  'howto.p.respawn': 'застрял — вернуться на флажок',
  'howto.p.tip1': 'На задачу три попытки. Не вышло — покажем решение и всё равно дадим ключ.',
  'howto.p.tip2': 'Собирай монеты: на них в Гардеробе одевают героя.',
  'howto.d.move': 'ходить',
  'howto.d.aim': 'целиться и стрелять — мышью или правым джойстиком',
  'howto.d.dash': 'рывок-уклонение',
  'howto.d.nova': 'способность: Нова / Мороз / Хил — меняется подбором на полу',
  'howto.d.shield': 'щит — пара секунд неуязвимости',
  'howto.d.swap': 'сменить оружие',
  'howto.d.interact': 'открыть сундук, спуститься на этаж ниже',
  'howto.d.tip1': 'Пока в комнате есть враги, двери заперты.',
  'howto.d.tip2': 'Реши задачу из сундука — получишь усиление на весь забег.',
  'howto.d.tip3': 'Монеты за забег копятся на постоянные улучшения в хабе.',
  'howto.common.pause': 'пауза',
  ...
  'settings.hints': 'Подсказка управления внизу',
